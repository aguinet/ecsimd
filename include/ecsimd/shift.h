...
const auto pad(WBN const& v) {
  ...
  ret_ty ret;
  eve::detail::for_<0,1,v_nlimbs>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
    eve::get<i>(ret) = eve::get<i>(v);
  });
  eve::detail::for_<v_nlimbs,1,ret_nlimbs>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
...
auto limb_shift_left(WBN const& v)
{
  ...
  ret_ty ret;
  eve::detail::for_<0,1,ShiftBy>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
    eve::get<i>(ret) = eve::zero(eve::as(eve::get<i>(ret)));
  });
  eve::detail::for_<ShiftBy,1,ShiftBy+v_nlimbs>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
    eve::get<i>(ret) = eve::get<i-ShiftBy>(v);
  });
  eve::detail::for_<ShiftBy+v_nlimbs, 1, RetLimbs>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
    eve::get<i>(ret) = eve::zero(eve::as(eve::get<i>(ret)));
  });
  return ret;
...
auto limb_shift_right(WBN const& v)
{
  ...
  ret_ty ret;
  eve::detail::for_<0,1,ret_limbs>([&](auto i_) {
    constexpr auto i = decltype(i_)::value;
    eve::get<i>(ret) = eve::get<i+ShiftBy>(v);
  });
  return ret;
